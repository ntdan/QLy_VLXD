...
public class SQLite_DB extends SQLiteOpenHelper {
    public SQLite_DB(Context context) {
        super(context, "vlxd.sqlite", null, 4);
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            db.execSQL("CREATE TABLE orders (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, customerid INTEGER, paydate VARCHAR, completed BOOL,shipaddress VARCHAR)");
